...
import Man from '../../../../public/images/nuradeen.png'
        ...
        <div className='w-[80%] md:w-[80%] flex flex-col-reverse md:flex-row justify-center md:justify-between items-center md:items-start'>
            <div className='w-full md:w-[45%]'>
                <div>
                   ...
                   <h1 className='text-[28px] font-[500] capitalize'> NURADEEN ABDULMUMIN LL.B, BL</h1>
                    ...
                    <p className='font-[400] text-[16px] text-justify'>Nuradeen graduated from Usman Dan fodio University, Sokoto and obtained LL.B in year 2014 and thereafter went to the Nigerian Law School, Enugu Campus where he obtained his BL and was called to Nigerian Bar in year 2015.  He worked with the Law Firm of E. Osoka & Co before joining the Law firm of Mahmud & Co in year 2016.</p>
                ...
                <h1 className='text-[28px] font-[500] mt-10'>Education</h1>
                    <ul className='list-disc flex flex-col gap-4 text-[16px] mt-2'>
                        <li>Usmanu Danfodio University Sokoto (Udus) LLB.</li>
                        <li>Augustine Nnamani Campus, Agbani, Enugu State. BL.</li>
                        <li>Nassarawa State University, Keffi, Nassarawa State. LLM (IN-VIEW)</li>
