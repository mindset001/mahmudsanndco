...
import Man from '../../../../public/images/edet.png'
        ...
        <div className='w-[80%] md:w-[80%] flex flex-col-reverse md:flex-row justify-center md:justify-between items-center md:items-start'>
            <div className='w-full md:w-[45%]'>
                <div>
                   ...
                   <h1 className='text-[28px] font-[500] capitalize'> EDET UDO AKPAN LL.B, BL</h1>
                    ...
                    <p className='font-[400] text-[16px] text-justify'>Edet Udo Akpan is a lawyer and an Administrator. He holds Bachelor of Science Degree (BSC) in Public Administration from the University of Calabar (1998) and a Master’s degree in Public Policy & Administration from Bayero University, Kano (2006). He also holds an LL.B Law degree from the University of Calabar (2010) and B.L from the Nigerian Law School, Lagos Campus. He was called to the Nigerian Bar in 2012. He worked with the Federal High Court as Registrar and Division Head in several states of the Federation before joining the prestigious Law Firm of Mahmud SAN & Co in the year 2018.</p>
                ...
                <h1 className='text-[28px] font-[500] mt-10'>Education</h1>
                    <ul className='list-disc flex flex-col gap-4 text-[16px] mt-2'>
                        <li>University of Calabar Bsc Public Admin 1998</li>
                        <li>Bayero University, Kano (Masters in Public Policy and Administration (2005))</li>
