...
import Man from '../../../../public/images/gurama.png'
        ...
        <div className='w-[80%] md:w-[80%] flex flex-col-reverse md:flex-row justify-center md:justify-between items-center md:items-start'>
            <div className='w-full md:w-[45%]'>
                <div>
                   ...
                   <h1 className='text-[28px] font-[500] capitalize'>  FATIMA GURAMA LL.B & SHARIA HONS, B.L </h1>
                   <h2 className='text-[20px] font-[600]'>Counsel</h2>
                    ...
                    <p className='font-[400] text-[16px] text-justify'>Fatima is highly organized and skilled in Complex Sharia Matters, Criminal Litigations and Professional Responsibility. Adept at litigation preparations through research for potential courses of action in a novel area of Law.  She’s currently undergoing her PhD Program and was called to the Nigerian bar in 2017. She’s a graduate of University of Maiduguri where she obtained LL.B & SHARIA HONS. </p>
                ...
                <h1 className='text-[28px] font-[500] mt-10'>Education</h1>
                    <ul className='list-disc flex flex-col gap-4 text-[16px] mt-2'>
                        <li>Masters of Law in Alternative Dispute Resolution (L.LM), </li>
                        <li>Nigerian Law School (BL), </li>
                        <li>University of Maiduguri (LLB &a SHARIA HONS)</li>
                ...
                <h1 className='text-[28px] font-[500] mt-10'>Practice Areas</h1>
                    <ul className='list-disc flex flex-col gap-4 text-[16px] mt-2'>
                        <li>Drafting of legal process, letters, deeds, contracts and trial preparations</li>
