            ...
            <div className='w-full md:w-[45%]'>
                <div>
                   ...
                   <h1 className='text-[28px] font-[500] capitalize'>KHADIJAH MUSTAPAH LL.B, B.L</h1>
                    ...
                    <p className='font-[400] text-[16px] text-justify'>Khadijah Mustapah, Counsel, holds a postgraduate LL.M degree from the University of Dundee, Scotland (2017-2018). She obtained her B.L from the Nigerian Law School, Bwari, Abuja (2015-2016) and her LL.B from the University of Maiduguri, Faculty of Law, Borno State (2010-2015). Her early education includes attending Maiduguri International School (2004-2009) and Maiduguri Capital School (2003-2004, 2009-2010), as well as Care Bears School, Maiduguri (1999-2003).</p>
                         <p className='mt-4 font-[400] text-[16px] text-justify'>Khadijah gained work experience as a Junior Associate at A.B. Sulu Gambari & Co, Lagos in 2017. Her legal areas of interest include Criminal Justice, Human Rights, and Family Law. She is a member of the Nigerian Bar Association.</p>
