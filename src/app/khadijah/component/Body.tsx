...
import Man from '../../../../public/images/khadijah.png'
        ...
        <div className='w-[80%] md:w-[80%] flex flex-col-reverse md:flex-row justify-center md:justify-between items-center md:items-start'>
            <div className='w-full md:w-[45%]'>
                <div>
                   ...
                   <h1 className='text-[28px] font-[500] capitalize'>KHADIJAH MUSTAPAH LL.B, B.L</h1>
                ...
                <h1 className='text-[28px] font-[500] mt-10'>Education</h1>
                    <ul className='list-disc flex flex-col gap-4 text-[16px] mt-2'>
                        <li>Post Graduate Education-Llm University Of Dundee, Scotland (2017-
                            2018)</li>
                        <li>Nigerian Law School, Bwari Abuja (2015-2016)</li>
                        <li>University Education- University Of Maiduguri, Faculty Of Law, Borno
                        State (2010-2015)</li>
