...
import Man from '../../../../public/images/adedeji.png'
        ...
        <div className='w-[80%] md:w-[80%] flex flex-col-reverse md:flex-row justify-center md:justify-between items-center md:items-start'>
            <div className='w-full md:w-[45%]'>
                <div>
                   ...
                   <h1 className='text-[28px] font-[500] capitalize'>  RIDWANULLAHI ADEDEJI BAMIGBOYE LL.B, BL</h1>
                    ...
                    <p className='font-[400] text-[16px] text-justify'>Ridwanullahi Adedeji Bamigboye obtained his LL.B degree (Common and Islamic law) from the University of Ilorin, Nigeria in 2017 and was subsequently called to the Nigerian Bar in 2018. Ridwan is a budding, diligent, resourceful and success-driven lawyer. He is passionate about litigation, especially election petitions, corporate practice, investment law and policy; and Islamic law generally. He is also currently completing his LL.M at Nassarawa State Univerrsity, Keffi, Nigeria. He joined the prestigious law firm of Mahmud (SAN) & Co, in the year 2020..</p>
                ...
                <h1 className='text-[28px] font-[500] mt-10'>Education</h1>
                    <ul className='list-disc flex flex-col gap-4 text-[16px] mt-2'>
                        ...
                        <li>University of Ilorin - LL.B (Hons)</li>
                        <li>Nassarawa State Univerrsity- LL.M</li>
