...
import Man from '../../../../public/images/firdausi.png'
        ...
        <div className='w-[80%] md:w-[80%] flex flex-col-reverse md:flex-row justify-center md:justify-between items-center md:items-start'>
            <div className='w-full md:w-[45%]'>
                <div>
                   ...
                   <h1 className='text-[28px] font-[500] capitalize'>   FIRDAUSI IBRAHIM LL.B, BL</h1>
                   <h2 className='text-[20px] font-[600]'>Counsel</h2>
                    ...
                    <p className='font-[400] text-[16px] text-justify'>Firdausi obtained her LL.B from Baze University 2016 and was called to Nigerian Bar in year 2018.  Firdausi is passionate about Law and her passion for the noble profession was what gave her ultimate goal of becoming a remarkable Legal Practitioner. She joined the law firm of Mahmud & Co in year 2018 </p>
                ...
                <h1 className='text-[28px] font-[500] mt-10'>Education</h1>
                    <ul className='list-disc flex flex-col gap-4 text-[16px] mt-2'>
                        ...
                        <li>Baze University - LL.B (Hons)</li>
