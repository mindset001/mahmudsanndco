...
import Man from '../../../../public/images/sule.png'
        ...
        <div className='w-[80%] md:w-[80%] flex flex-col-reverse md:flex-row justify-center md:justify-between items-center md:items-start'>
            <div className='w-full md:w-[45%]'>
                <div>
                   ...
                   <h1 className='text-[28px] font-[500] capitalize'> HAUWA SULE IBRAHIM LL.B, B.L</h1>
                    ...
                    <p className='font-[400] text-[16px] text-justify'>Hauwa holds an LL.B from Ahmadu Bello University and was called to the Nigerian Bar in 2016. She is a savvy lawyer with an astounding skill in legal drafting and litigation. She acquired a Certificate in Corporate Strategy (University of London) in a bid to satiate her drive for personal development.</p>
