...
import Man23 from '../../../../public/images/dada.png'
import Man24 from '../../../../public/images/khadijah.png'
import Man25 from '../../../../public/images/zakiyyah.png'
import Man26 from '../../../../public/images/zulu.png'
import Man27 from '../../../../public/images/cyril.png'
import Man28 from '../../../../public/images/eleja.png'
   ...
   <main className='flex flex-col justify-center items-center'>
     ...
     <div className='w-full'>
        <div className='w-full flex flex-col md:flex-row mt-16'>
            ...
            <div className='relative flex flex-row-reverse md:flex-row md:w-1/2 items-center'>
                ...
                <Link href='/ayeye'>  <h1 className='text-[20px] font-[500]'> DANJUMA G. AYEYE</h1>
        ...
        <div className='w-full flex flex-col md:flex-row'>
            ...
            <div className='w-1/2'>
                ...
                <div className='absolute left-[40%] w-[153px] z-10 h-[1px] bg-[#5C5A5A] '></div>
                <div className=' h-[265px] md:h-[440px] w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                <Link href='/hauwa'>  <h1 className='text-[20px] font-[500]'> HAUWA TUMAKA</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
            ...
            <div className='w-1/2 '>
                ...
                <Link href='/hamidu'> <h1 className='text-[20px] font-[500]'> HAMIDU MOHAMMED</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
     ...
     <div className='w-full'>
        <div className='w-full flex flex-col md:flex-row'>
            <div className='relative items-center flex md:w-1/2'>
                <div className=' h-[265px]  md:h-[440px] w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                <Link href='/adedeji'> <h1 className='text-[20px] font-[500]'> RIDWANULLAHI ADEDEJI</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
            ...
            <div className='relative flex flex-row-reverse md:flex-row md:w-1/2 items-center'>
                ...
                <Link href='/badmos'>    <h1 className='text-[20px] font-[500]'>ABDULKABIR ABIODUN</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
        ...
        <div className='w-full flex flex-col md:flex-row'>
            ...
            <div className='w-1/2'>
                ...
                <div className='absolute left-[40%] w-[153px] z-10 h-[1px] bg-[#5C5A5A] '></div>
                <div className=' h-[265px] md:h-[440px] w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                <Link href='/ashaolu'> <h1 className='text-[20px] font-[500]'> COMFORT BUNMI</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
            ...
            <div className='w-1/2 '>
                ...
                <div className=' h-[265px] md:h-[440px]   z-0 w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                   <Link href='/clement'> <h1 className='text-[20px] font-[500]'>CLEMENT OPU</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
     ...
     <div className='w-full'>
        <div className='w-full flex flex-col md:flex-row'>
            <div className='relative items-center flex md:w-1/2'>
                <div className=' h-[265px] md:h-[440px] w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                   <Link href='/ede'> <h1 className='text-[20px] font-[500] uppercase'>ede uko</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
            ...
            <div className='relative flex flex-row-reverse md:flex-row md:w-1/2 items-center'>
                ...
                <Link href='/edet'>  <h1 className='text-[20px] font-[500]'> EDET UDO</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
        ...
        <div className='w-full flex flex-col md:flex-row'>
            ...
            <div className='w-1/2'>
                ...
                <div className='absolute left-[40%] w-[153px] z-10 h-[1px] bg-[#5C5A5A] '></div>
                <div className=' h-[265px] md:h-[440px] w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                <Link href='/udzahu'>  <h1 className='text-[20px] font-[500]'> UDZAHU MEDUGU</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
            ...
            <div className='w-1/2 '>
                ...
                <div className=' h-[265px] md:h-[440px]   z-0 w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                <Link href='/grema'> <h1 className='text-[20px] font-[500]'>MUNAKUR GREMA</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
     ...
     <div className='w-full'>
        <div className='w-full flex flex-col md:flex-row'>
            <div className='relative items-center flex md:w-1/2'>
                <div className=' h-[265px]  md:h-[440px] w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                <Link href='/chima'> <h1 className='text-[20px] font-[500]'> CHIMA CHIEMEZIE</h1>
                    <p  className='text-[14px] font-[400]'>Senior Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
        ...
        <div className='w-full flex flex-col md:flex-row'>
            ...
            <div className='w-1/2 '>
                ...
                <div className=' h-[265px] md:h-[440px]   z-0 w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                   <Link href='/benita'> <h1 className='text-[20px] font-[500]'>BENITA O. ODIGIE</h1>
                    <p  className='text-[14px] font-[400]'>Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
     ...
     <div className='w-full'>
        <div className='w-full flex flex-col md:flex-row'>
            <div className='relative items-center flex md:w-1/2'>
                <div className=' h-[265px]  md:h-[440px] w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                <Link href='/rufaida'> <h1 className='text-[20px] font-[500]'> RUFAIDA ADAMU</h1>
                    <p  className='text-[14px] font-[400]'>Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
            ...
            <div className='relative flex flex-row-reverse md:flex-row md:w-1/2 items-center'>
                ...
                <Link href='/firdausi'>    <h1 className='text-[20px] font-[500]'>FIRDAUSI IBRAHIM</h1>
                    <p  className='text-[14px] font-[400]'>Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
     ...
     <div className='w-full'>
        <div className='w-full flex flex-col md:flex-row'>
            ...
            <div className='relative flex flex-row-reverse md:flex-row md:w-1/2 items-center'>
                ...
                <div className='absolute left-[40%] w-[153px] z-10 h-[1px] bg-[#5C5A5A] '></div>
                <div className='w-1/2'>
                    <Image src={Man24} alt='' className='w-full  h-[265px] md:h-[440px] '/>
                </div>
            </div>
        </div>
        ...
        <div className='w-full flex flex-col md:flex-row'>
            ...
            <div className='w-1/2'>
                ...
                <div className='absolute left-[40%] w-[153px] z-10 h-[1px] bg-[#5C5A5A] '></div>
                <div className=' h-[265px] md:h-[440px] w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                <Link href='/zakiyyah'>  <h1 className='text-[20px] font-[500]'>  ZAKIYYAH SANUSI LAWAL</h1>
                    <p  className='text-[14px] font-[400]'>Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
            ...
            <div className='w-1/2 '>
                ...
                <div className=' h-[265px] md:h-[440px]   z-0 w-1/2  bg-[#FFF1C6] flex flex-col justify-center pl-10 md:pl-40 gap-[2px]'>
                <Link href='/zulu'> <h1 className='text-[20px] font-[500]'>ZULU-GAMBARI YUSU</h1>
                    <p  className='text-[14px] font-[400]'>Counsel</p>
                    <Image src={Right} alt='' className='w-[18px] h-[18px]'/>
                    </Link>
                </div>
     ...
     <div className='w-full'>
        <div className='w-full flex flex-col md:flex-row'>
            ...
            <div className='relative flex flex-row-reverse md:flex-row md:w-1/2 items-center'>
                ...
                <div className='absolute left-[40%] w-[153px] z-10 h-[1px] bg-[#5C5A5A] '></div>
                <div className='w-1/2'>
                    <Image src={Man28} alt='' className='w-full  h-[265px] md:h-[440px] '/>
                </div>
            </div>
        </div>
